...
def radar_eletronico(velocidade):
    km_rodado = 5                   #valor da multa por quilômetro rodado

    if velocidade > 80:             #condição pra checar se o motorista está dentro do limite
        print(f"Você foi multado por excesso de velocidade")
        multa=90 + (velocidade-80) * km_rodado
        print(f"Sua multa é de R${multa} ")
    else:
        print("Você se manteve dentro do limite")
